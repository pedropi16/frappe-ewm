...
| Labor management | Standards, planned vs actual, performance | Advanced | Missing (`Warehouse Task.started_at` is now actually populated as of P3, previously dead schema - still no standards table or performance report) | Standards table, performance report |
