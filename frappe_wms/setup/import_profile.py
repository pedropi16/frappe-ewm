...
# configurator's scope changes.
APPLY_ORDER = [
    "Bin Type", "Handling Unit Type", "Packaging Spec", "WMS Exception Code",
    "WMS Movement Type", "WMS Stock Type", "Packaging Material", "WMS Settings",
    "Warehouse Process Type", "Activity Area", "Billing Rate", "Bin Determination Rule",
    "Count Tolerance Group", "Cycle Count Rule", "Inspection Rule", "Labor Standard",
    "Process Determination Rule", "Removal Rule", "Replenishment Rule", "Storage Bin",
    "WMS Warehouse", "Storage Process", "Storage Type", "Storage Type Search Sequence",
    "WMS Number Range", "WMS Resource Group", "WMS Route", "WO Creation Rule",
    "Warehouse Process Type Determination Rule", "Work Center", "Storage Section",
    "WMS HU Number Pool", "Warehouse Queue", "Wave Template", "WMS Resource",
...
def import_profile(path, dry_run=False):
    ...
    for doctype in APPLY_ORDER:
        ...
        for record in records:
            name = _compute_name(doctype, record, key)
            if dry_run:
