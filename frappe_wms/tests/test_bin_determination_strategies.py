...
class TestBinDeterminationStrategies(IntegrationTestCase):
    ...
    def test_bin_sequence_strategy_picks_lowest_sequence(self):
        ...
        result = determine_destination_bin({"warehouse": self.warehouse, "activity": "Putaway", "item": self.item, "stock_type": "AVAILABLE", "hu_type": None, "source_storage_type": None})
    ...
    def test_manual_selection_strategy_throws_instead_of_guessing(self):
        ...
        with self.assertRaises(frappe.ValidationError):
            determine_destination_bin({"warehouse": self.warehouse, "activity": "Putaway", "item": self.item, "stock_type": "AVAILABLE", "hu_type": None, "source_storage_type": None})
