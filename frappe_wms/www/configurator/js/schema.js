...
/** Short explanation for a non-configurable node on the map (day-to-day document or ERPNext doctype). */
export function runtimeIntro(name) { return _runtimeIntro[name] || ""; }

/** Day-to-day doctypes -> the doctypes they link to. Generated by tools/extract_schema.py. */
export function runtime() { return schema().runtime || {}; }
