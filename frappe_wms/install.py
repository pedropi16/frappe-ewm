...
def after_install():
    ...
    process=[("GR_UNLOAD","Goods Receipt Unload","Unload","301"),("GR_PUTAWAY","Goods Receipt Putaway","Putaway","201"),("OB_PICK","Outbound Picking","Pick","401"),("OB_STAGE","Outbound Staging","Stage","301"),("OB_LOAD","Outbound Loading","Load","301"),("INTERNAL_MOVE","Internal Movement","Internal Move","301"),("DECON","Deconsolidation","Deconsolidation","301"),("PACK_REPACK","Packing and Repacking","Pack","801"),("STOCK_TYPE_CHANGE","Stock Type Change","Posting Change","501"),("REPLENISH","Pick Face Replenishment","Putaway","201")]
    ...
    all_task_types=["Unload","Putaway","Pick","Internal Move","Deconsolidation","Stage","Load","Posting Change","Inventory Count"]
    exceptions=[
        ("OOS","Out of Stock at Location","Stock",0,0,["Pick"]),
        ("DAMAGED","Damaged Product Found","Stock",0,1,["Unload","Putaway","Pick","Internal Move","Deconsolidation"]),
        ("BIN_BLOCKED","Bin Blocked or Inaccessible","Bin",0,0,["Putaway","Pick","Internal Move","Deconsolidation","Stage"]),
        ("HU_DAMAGED","Handling Unit Damaged","Handling Unit",0,1,["Unload","Putaway","Pick","Internal Move","Deconsolidation","Load"]),
        ("WRONG_ITEM","Wrong Item Scanned","Task",0,1,all_task_types),
        ("QTY_MISMATCH","Quantity Mismatch","Task",0,1,["Unload","Putaway","Pick","Deconsolidation","Inventory Count"]),
